...
const TopicForm = ({ setResult, setLoading, loading, setError }) => {
  ...
  return (
    <motion.div
      ...
      className='rounded-2xl bg-linear-to-br from-black/90
     via-black/80 to-black/90 backdrop-blur-2xl
     border border-white/10 shadow-[0_25px_60px_rgba(0 , 0 ,0 , 0,0.75)]
     p-8 space-y-6 text-white'>
      ...
      <input type="text" className='w-full p-3 rounded-xl
        ...
        focus:ring-2 focus:ring-white/30' placeholder='Enter topic (e.g. Web development)'
      ...
      <input type="text" className='w-full p-3 rounded-xl
        bg-white/10 backdrop-blur-lg border border-white/20 
        placeholder-gray-400 text-white focus:outline-none 
        focus:ring-2 focus:ring-white/30' placeholder='Class / Level (e.g. Class 10)'
      ...
      <input type="text" className='w-full p-3 rounded-xl
        bg-white/10 backdrop-blur-lg border border-white/20 
        placeholder-gray-400 text-white focus:outline-none 
        focus:ring-2 focus:ring-white/30' placeholder='Enter Type (e.g. CBSE , JEE , NEET)'
...
function Toggle({ label, checked, onChange }) {
  return (
    <div className='flex items-center gap-4 cursor-pointer select-none'
      ...
      <span className='{`text-sm transition-colors ${checked ?
           "text-green-300" : "text-gray-300}`}'>{label}</span>
