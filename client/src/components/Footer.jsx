...
const Footer = () => {
    ...
    return (
        <motion.div
            ...
            className='z-10 mx-6 mt-24 rounded-2xl bg-linear-to-br from-black/90
    via-black/80 to-black/90 backdrop-blur-2xl
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 items-start'>
                    ...
                    <div className='flex items-center gap-3 cursor-pointer'
                     style={{ transform: "translateZ(20px)" }}>
                        ...
                        <span className='text-lg font-semibold bg-linear-to-br from-white via-gray-300 to-white bg-clip-text text-transparent'
                            ...
                            style={{ textShadow: "0 6px 18px rgba(0 , 0 , 0 , 0 , 0.4" }}>ExamNotes
                ...
                <div className='text-center'>
                 ...
                 <div className='text-center'>
                    <h1 className='text-sm font-semibold text-white mb-4 '>Quick Links</h1>
                    <ul className='space-y-2 text-sm'>
                        <li onClick={handleSignOut} className='text-gray-300 hover:text-white transition-colors cursor-pointer'>Support & Account</li>
                        <li onClick={()=>navigate("/auth")} className='text-red-400 hover:text-red-300 transition-colors cursor-pointer'>SignOut</li>
                        <li className='text-gray-300 hover:text-white transition-colors cursor-pointer'>Email : ra7140558@gmail.com</li>
                    </ul>
                </div>
