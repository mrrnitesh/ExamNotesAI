...
const Navbar = () => {
   ...
   // const serverUrl = "http://localhost:5173/auth";
    const serverUrl = "https://examnotesaiserver-u6sq.onrender.com/auth";
            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    {showCredits &&
                            ...
                            className="absolute right-5 mt-4 w-64
                              rounded-2xl
                            bg-black/90 backdrop-blur-xl
                              ...
                              p-4 text-white">
                                ...
                                className='w-full py-2 rounded-lg bg-linear-to-br from-white
                                to-gray-200 text-black font-semibold 
                                hover:opacity-90 cursor-pointer'>Buy More Credits</button>
                            </motion.div>
                        } </AnimatePresence>
                </div>
                ...
                <div className='relative'>
                    <motion.div
                     ...
                     text-white text-sm shadow-md
                     cursor-pointer'>
                        <span className='text-md'>{userData.name.slice(0 ,1).toUpperCase()}</span>
