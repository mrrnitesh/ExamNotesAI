...
const Notes = () => {
    ...
    return (
        <div className='min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-6 py-5'>
            <motion.header
        ...
        px-6 py-5  shadow-[0_20px_45px_rgba(0,0,0,0.6)] items-center
        flex md:items-center justify-between gap-4 flex-col md:flex-row"
            >
                ...
                <div className='flex items-center gap-4' >
                    ...
                    py-2 rounded-full bg-white/10 border border-white/20 
                    text-white text-sm cursor-pointer' onClick={() => navigate("/pricing")} >
                    ...
                    <button className='px-4 py-3 rounded-full text-sm font-medium
                    bg-white/10 border border-white/20 text-white 
                    hover:bg-white/20 transtion flex items-center gap-2'
