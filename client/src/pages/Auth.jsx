  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      <motion.header
        ...
        className="max-w-7xl mx-auto mt-6 rounded-2xl 
      ...
      <main className='max-w-6xl mx-auto py-7 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        ...
        >
          ...
          <p className=' mt-6 max-w-xl text-lg bg-linear-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent'>You get <span className="font-semibold">50 FREE credits</span> to create
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <Feature icon={"🎁"} title="Start with 50 credits" des={"Start with 50 credits to generate notes without paying."} />
